...
3. **Class Comparison**: Khi tìm được class SinhVien tương ứng `MappedNode`:
   ...
   - So sánh Method Set: Getter/Setter chỉ đếm tổng số lượng (báo lỗi lệch count). Method thường thì Tên similarity >= 0.5; Kiểu trả về khớp tuyệt đối; Params không lo tên nhưng khớp tuyệt đối thứ tự và Kiểu (sau TypeMap); Scope khớp tuyệt đối.
